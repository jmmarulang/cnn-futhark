...
d_isBin_1426 ::
  ...
  MAlonzo.Code.Lang.T_E_182 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
d_isBin_1426 ~v0 ~v1 v2 = du_isBin_1426 v2
du_isBin_1426 ::
  MAlonzo.Code.Lang.T_E_182 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
du_isBin_1426 v0
...
d_isScaledown_1504 ::
  ...
  MAlonzo.Code.Lang.T_E_182 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
d_isScaledown_1504 ~v0 ~v1 v2 = du_isScaledown_1504 v2
du_isScaledown_1504 ::
  MAlonzo.Code.Lang.T_E_182 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
du_isScaledown_1504 v0
  = case coe v0 of
      MAlonzo.Code.Lang.C_var_184 v3
        -> coe
             MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32
...
d_isLet_1584 ::
  ...
  MAlonzo.Code.Lang.T_E_182 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
d_isLet_1584 ~v0 ~v1 v2 = du_isLet_1584 v2
du_isLet_1584 ::
  MAlonzo.Code.Lang.T_E_182 ->
  MAlonzo.Code.Relation.Nullary.Decidable.Core.T_Dec_20
du_isLet_1584 v0
...
d_'42''8776''45'uniq_1666 ::
  ...
  MAlonzo.Code.Ar.T_Pointw'8323'_990 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'42''8776''45'uniq_1666 = erased
-- LangEq.+≈-uniq
d_'43''8776''45'uniq_1692 ::
  [Integer] ->
  [Integer] ->
  [Integer] ->
  MAlonzo.Code.Ar.T_Pointw'8323'_990 ->
  MAlonzo.Code.Ar.T_Pointw'8323'_990 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_'43''8776''45'uniq_1692 = erased
-- LangEq.suc≈-uniq
d_suc'8776''45'uniq_1718 ::
  [Integer] ->
  [Integer] ->
  MAlonzo.Code.Ar.T_Pointw'8322'_968 ->
  MAlonzo.Code.Ar.T_Pointw'8322'_968 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_suc'8776''45'uniq_1718 = erased
-- LangEq.cong₃
d_cong'8323'_1750 ::
  () ->
  () ->
  ...
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12 ->
  MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d_cong'8323'_1750 = erased
-- LangEq._≟ᵉ_
d__'8799''7497'__1756 ::
  MAlonzo.Code.Lang.T_Ctx_12 ->
  MAlonzo.Code.Lang.T_IS_6 ->
  MAlonzo.Code.Lang.T_E_182 ->
  MAlonzo.Code.Lang.T_E_182 ->
  Maybe MAlonzo.Code.Agda.Builtin.Equality.T__'8801'__12
d__'8799''7497'__1756 v0 v1 v2 v3
  = case coe v2 of
      ...
      MAlonzo.Code.Lang.C_bin_210 v6 v7 v8
        -> let v9 = coe du_isBin_1426 (coe v3) in
           coe
             (case coe v9 of
      ...
      MAlonzo.Code.Lang.C_scaledown_212 v6 v7
        -> let v8 = coe du_isScaledown_1504 (coe v3) in
           coe
             (case coe v8 of
                MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32 v9 v10
                  -> if coe v9
      ...
      MAlonzo.Code.Lang.C_let'8242'_214 v5 v7 v8
        -> let v9 = coe du_isLet_1584 (coe v3) in
           coe
             (case coe v9 of
                MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32 v10 v11
                  -> if coe v10
...
d_e'45'eq'63'_3066 v0 v1 v2 v3 v4
         ...
         MAlonzo.Code.Relation.Nullary.Decidable.Core.C__because__32 v6 v7
           -> if coe v6
                then coe
                       ...
                       (coe
                          MAlonzo.Code.Data.Maybe.Base.du__'62''62''61'__72
                          (coe d__'8799''7497'__1756 (coe v0) (coe v1) (coe v3) (coe v4))
                          (coe
                             (\ v8 ->
                                coe
                                  MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
