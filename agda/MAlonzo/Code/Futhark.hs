...
-- Futhark._.Sem
d_Sem_80 :: MAlonzo.Code.Lang.T_IS_30 -> ()
d_Sem_80 = erased
-- Futhark._.FEnv
d_FEnv_86 :: MAlonzo.Code.Lang.T_Ctx_36 -> ()
d_FEnv_86 = erased
-- Futhark._.lookup
d_lookup_92 ::
...
d_to'45'max_318 ::
  ...
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_to'45'max_318 v0 v1 v2
  = let v3
          = coe
              MAlonzo.Code.Text.Printf.d_printf_26
              ("(imaximum%u %s (\\%s -> %s))" :: Data.Text.Text)
    ...
    coe
      (case coe v0 of
         [] -> coe v2
         _ -> coe v3)
-- Futhark._.to-softmax
d_to'45'softmax_336 ::
  [Integer] ->
  T_Ix_74 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6 ->
  MAlonzo.Code.Agda.Builtin.String.T_String_6
d_to'45'softmax_336 v0 v1 v2
  = let v3
          = coe
              MAlonzo.Code.Text.Printf.d_printf_26
...
d_ix'45'plus_352 v0 v1 v2 v3 v4 v5 v6 v7
  = case coe v4 of
...
d_ix'45'minus_380 ::
  ...
  MAlonzo.Code.Ar.T_Pointw'8323'_990 ->
  MAlonzo.Code.Ar.T_Pointw'8322'_968 -> T_Ix_74 -> T_Ix_74 -> T_Ix_74
d_ix'45'minus_380 v0 v1 v2 v3 v4 v5 v6 v7
  = case coe v4 of
      MAlonzo.Code.Ar.C_'91''93'_994
        -> coe
             seq (coe v5)
...
d_to'45'div'45'mod_394 ::
  [Integer] ->
  [Integer] ->
  [Integer] ->
  MAlonzo.Code.Ar.T_Pointw'8323'_990 ->
  T_Ix_74 -> MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_to'45'div'45'mod_394 v0 v1 v2 v3 v4
  = case coe v3 of
      MAlonzo.Code.Ar.C_'91''93'_994
        -> coe
             seq (coe v4)
                             ...
                             -> case coe v4 of
                                  C__'8759'__78 v21 v22
                                    -> coe
                                         ...
                                         (coe
                                            d_to'45'div'45'mod_394 (coe v14) (coe v16) (coe v18)
                                            (coe v12) (coe v22))
                                  _ -> MAlonzo.RTE.mazUnreachableError
                           _ -> MAlonzo.RTE.mazUnreachableError
                    _ -> MAlonzo.RTE.mazUnreachableError
...
d_from'45'div'45'mod_408 ::
  [Integer] ->
  [Integer] ->
  [Integer] ->
  MAlonzo.Code.Ar.T_Pointw'8323'_990 -> T_Ix_74 -> T_Ix_74 -> T_Ix_74
d_from'45'div'45'mod_408 v0 v1 v2 v3 v4 v5
  = case coe v3 of
      MAlonzo.Code.Ar.C_'91''93'_994
                                    ...
                                    (d_to'45'fut_428
                                       ...
                                       (coe
                                          ...
                                          (coe
                                             ...
                                             (coe
                                                d_to'45'div'45'mod_394 (coe v4) (coe v5) (coe v10)
                                                (coe v8) (coe v11)))))
                                    v12)
                                 (\ v13 ->
                                    case coe v13 of
                                        ...
                                        -> coe
                                             ...
                                             (coe
                                                ...
                                                (coe
                                                   ...
                                                   (MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
                                                      (coe
                                                         d_to'45'div'45'mod_394 (coe v4) (coe v5)
                          ...
                          MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v12 v13
                            -> coe
                                 ...
                                 (coe
                                    ...
                                    (coe d___68 () erased) erased erased
                                    (d_to'45'fut_428
                                       (coe v0) (coe MAlonzo.Code.Lang.C_ix_32 (coe v5)) (coe v8)
                                       (coe v3))
                                    (\ v14 ->
                                       coe
                                         MAlonzo.Code.Effect.Monad.d__'62''62''61'__34
                                         (coe d___68 () erased) erased erased
                                         (d_to'45'fut_428 (coe v0) (coe v1) (coe v9) (coe v3))
                                         (\ v15 ->
                                            coe
                                              MAlonzo.Code.Effect.Applicative.du_return_68
                                              (MAlonzo.Code.Effect.Monad.d_rawApplicative_32
                    ...
                    (coe
                       (\ v9 ->
                          coe
                            ...
                            (coe
                               MAlonzo.Code.Effect.Monad.State.Transformer.Base.d_runStateT_68
                               (d_to'45'fut_428 (coe v0) (coe v1) (coe v7) (coe v3)) v9)
                            (\ v10 ->
                               case coe v10 of
                                 MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v11 v12
                                   -> coe
                                        ...
                                        (coe
                                           MAlonzo.Code.Effect.Monad.d__'62''62''61'__34
                                           (coe d___68 () erased) erased erased
                                           (d_to'45'fut_428 (coe v0) (coe v1) (coe v8) (coe v3))
                                           (\ v13 ->
                                              coe
                                                MAlonzo.Code.Effect.Applicative.du_return_68
                                                (MAlonzo.Code.Effect.Monad.d_rawApplicative_32
             ...
             (coe
                (\ v8 ->
                   coe
                     ...
                     (coe
                        MAlonzo.Code.Effect.Monad.State.Transformer.Base.d_runStateT_68
                        (d_to'45'fut_428 (coe v0) (coe v1) (coe v7) (coe v3)) v8)
                     (\ v9 ->
                        case coe v9 of
                          MAlonzo.Code.Agda.Builtin.Sigma.C__'44'__32 v10 v11
                            -> coe
...
d__'44''44'__892 v0 v1 v2 v3
  = coe MAlonzo.Code.Data.Product.Base.du__'44''8242'__84
-- Futhark.Test.test-e
d_test'45'e_894 :: MAlonzo.Code.Lang.T_E_214
d_test'45'e_894
  = coe
            ...
            coe
              ...
              (coe
                 ...
                 (coe
                    ...
                    (coe MAlonzo.Code.Agda.Builtin.List.C_'91''93'_16))
                 (coe
                    MAlonzo.Code.Lang.C_un_248 (coe MAlonzo.Code.Lang.C_squared_202)
                    (coe
                       v0
                       (coe
...
-- Futhark.Test.test-s
d_test'45's_900 :: MAlonzo.Code.Agda.Builtin.String.T_String_6
d_test'45's_900
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
      (coe
         ...
         (coe (0 :: Integer)))
-- Futhark.Test.test-f
d_test'45'f_902 :: MAlonzo.Code.Agda.Builtin.String.T_String_6
d_test'45'f_902 = coe d_e_918
-- Futhark.Test._.a
d_a_908 ::
  MAlonzo.Code.Effect.Monad.State.Transformer.Base.T_StateT_58
d_a_908
...
d_b_910
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
      (coe
         MAlonzo.Code.Effect.Monad.State.du_runState_20 (coe d_a_908)
         (coe (0 :: Integer)))
-- Futhark.Test._.c
d_c_912 ::
  MAlonzo.Code.Effect.Monad.State.Transformer.Base.T_StateT_58
d_c_912
  = coe
      d_b_910
      (coe
         C__'8759'__78 ("samurai" :: Data.Text.Text)
         (coe C__'8759'__78 ("aku" :: Data.Text.Text) (coe C_'91''93'_76)))
-- Futhark.Test._.d
d_d_914 :: MAlonzo.Code.Agda.Builtin.Sigma.T_Σ_14
d_d_914
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
      (coe
         MAlonzo.Code.Effect.Monad.State.du_runState_20 (coe d_c_912)
         (coe (1 :: Integer)))
-- Futhark.Test._.e
d_e_918 :: MAlonzo.Code.Agda.Builtin.String.T_String_6
d_e_918
  = coe MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30 (coe d_d_914)
-- Futhark.Test.test-sf
d_test'45'sf_920 :: MAlonzo.Code.Agda.Builtin.String.T_String_6
d_test'45'sf_920
  = coe
      MAlonzo.Code.Text.Printf.d_printf_26
      ("%s \n \n %s" :: Data.Text.Text) d_test'45'f_902 d_test'45's_900
-- Futhark.Test.loss-e
d_loss'45'e_922 :: MAlonzo.Code.Lang.T_E_214
d_loss'45'e_922
  = coe
      MAlonzo.Code.Lang.du_Lcon_1476
      (coe
         ...
         (\ v0 v1 ->
            coe
              ...
              (coe
                 (\ v2 ->
                    coe
                      MAlonzo.Code.Lang.C_scaledown_244 (2 :: Integer)
                      (coe
                         MAlonzo.Code.Lang.C_bin_242 (coe MAlonzo.Code.Lang.C_mul_192)
                         (coe
                            ...
                            (coe
                               ...
                               (coe
                                  ...
                                  (coe
                                     ...
                                     (coe MAlonzo.Code.Lang.C_zero_1334))))))))))
-- Futhark.Test.loss-s
d_loss'45's_930 :: MAlonzo.Code.Agda.Builtin.String.T_String_6
d_loss'45's_930
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
      (coe
         ...
         (coe (0 :: Integer)))
-- Futhark.Test.conv-e
d_conv'45'e_932 :: MAlonzo.Code.Lang.T_E_214
d_conv'45'e_932
  = coe
      MAlonzo.Code.Lang.du_Lcon_1476
      (coe
...
-- Futhark.Test.conv-s
d_conv'45's_938 :: MAlonzo.Code.Agda.Builtin.String.T_String_6
d_conv'45's_938
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
      (coe
         ...
         (coe (0 :: Integer)))
-- Futhark.Test.cnn-s
d_cnn'45's_940 :: MAlonzo.Code.Agda.Builtin.String.T_String_6
d_cnn'45's_940
  = coe
      MAlonzo.Code.Agda.Builtin.Sigma.d_snd_30
      (coe
