...
d_uop_102 v0
  = case coe v0 of
      ...
      MAlonzo.Code.Lang.C_exp_200 -> coe ("exp" :: Data.Text.Text)
      MAlonzo.Code.Lang.C_rectifier_202 -> coe ("relu" :: Data.Text.Text)
      MAlonzo.Code.Lang.C_squared_204 -> coe ("sqrt" :: Data.Text.Text)
      MAlonzo.Code.Lang.C_inverse_206 -> coe ("inv" :: Data.Text.Text)
      MAlonzo.Code.Lang.C_ind'45'positive_208
        -> coe ("ind-positive" :: Data.Text.Text)
      MAlonzo.Code.Lang.C_logarithm_210 -> coe ("ln" :: Data.Text.Text)
      _ -> MAlonzo.RTE.mazUnreachableError
-- PP.pars
d_pars_104 ::
  Bool ->
                                         ...
                                         (\ v16 ->
                                            coe
                                              ...
                                              (coe
                                                 ...
                                                 (coe
                                                    MAlonzo.Code.Text.Printf.d_printf_26
                                                    ("zero-but %s %s %s" :: Data.Text.Text) v14 v15
                                                    v16)))))
                                 v13
                          _ -> MAlonzo.RTE.mazUnreachableError)))
                                    ...
                                    (\ v13 ->
                                       coe
                                         ...
                                         (coe
                                            ...
                                            (coe
                                               MAlonzo.Code.Text.Printf.d_printf_26
                                               ("max \955 %s \8594 %s" :: Data.Text.Text) v12
                                               v13))))
                                 v11
                          _ -> MAlonzo.RTE.mazUnreachableError)))
      _ -> MAlonzo.RTE.mazUnreachableError
