...
module Extract where
  ...
  open Primitives.Microgpt

  model-s : String
  model-s = proj₂ (runState (to-str ( multiopt model-e OPT)
    (from-named (ε ▹
     "wpe" ▹ "wqry" ▹ "wkey" ▹ "wval" ▹ "wout" ▹ "wup" ▹ "wdown" ▹ "wvoc"
      ▹ "mask" ▹ "te"))) 0)

  model-pp : String
  model-pp = proj₂ (runState (PP.pp (multiopt model-e OPT)
    ((((((((((_ , "wpe") , "wqry") , "wkey") , "wval") , "wout") , "wup")
    , "wdown") , "wvoc") , "mask") , "te")) 0)

  gpt-loss-s : String
  gpt-loss-s = proj₂ (runState (to-str ( multiopt gpt-loss-e OPT)
    (from-named (ε ▹
     "wpe" ▹ "wqry" ▹ "wkey" ▹ "wval" ▹ "wout" ▹ "wup" ▹ "wdown" ▹ "wvoc"
      ▹ "mask" ▹ "te" ▹ "target"))) 0)

  gpt-loss-pp : String
  gpt-loss-pp = proj₂ (runState (PP.pp (multiopt gpt-loss-e OPT)
    (((((((((((_ , "wpe") , "wqry") , "wkey") , "wval") , "wout") , "wup")
