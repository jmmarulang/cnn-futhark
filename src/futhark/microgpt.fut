...
let x70 = (imap1 16 (\x71_0 -> (imaximum1 27 (\x72_0 -> x65[x71_0][x72_0]))))
let x73 = (imap2 16 27 (\x74_0 x74_1 -> (F.exp (x65[x74_0][x74_1] F.+ (F.neg x70[x74_0])))))
let x75 = (imap1 16 (\x76_0 -> (isum1 27 (\x77_0 -> x73[x76_0][x77_0]))))
let x78 = (imap2 16 27 (\x79_0 x79_1 -> (isum1 27 (\x80_0 -> (F.neg (if ((x80_0 == x79_1)) then (let x81 = (imaximum1 27 (\x84_0 -> x65[x79_0][x84_0]))
in (let x82 = (imap1 27 (\x85_0 -> (F.exp (x65[x79_0][x85_0] F.+ (F.neg x81)))))
in (let x83 = (isum1 27 (\x86_0 -> x82[x86_0]))
in (((((F.neg x68[x79_0]) F.* target[x79_0][x79_1]) F.* (one F./ (x82[x80_0] F.* (one F./ x83)))) F.* x73[x79_0][x80_0]) F.* (one F./ (x75[x79_0] F.* x75[x79_0])))))) else zero))))))
let x87 = (imap3 16 27 27 (\x88_0 x88_1 x88_2 -> ((if ((x88_2 == x88_1)) then (let x89 = (imaximum1 27 (\x92_0 -> x65[x88_0][x92_0]))
in (let x90 = (imap1 27 (\x93_0 -> (F.exp (x65[x88_0][x93_0] F.+ (F.neg x89)))))
in (let x91 = (isum1 27 (\x94_0 -> x90[x94_0]))
in ((((F.neg x68[x88_0]) F.* target[x88_0][x88_1]) F.* (one F./ (x90[x88_2] F.* (one F./ x91)))) F.* (one F./ x75[x88_0]))))) else zero) F.+ x78[x88_0][x88_1])))
let x95 = (imap2 16 27 (\x96_0 x96_1 -> (isum1 27 (\x97_0 -> (F.neg ((F.exp (x65[x96_0][x97_0] F.+ (F.neg x70[x96_0]))) F.* x87[x96_0][x96_1][x97_0]))))))
let x98 = (imap1 16 (\x99_0 -> x70[x99_0]))
let x100 = (imap1 16 (\x101_0 -> (one F./ (isum1 27 (\x102_0 -> (one F.+ (F.neg (indicatorp (F.neg (x65[x101_0][x102_0] F.+ (F.neg x98[x101_0])))))))))))
let x103 = (imap2 16 27 (\x104_0 x104_1 -> (isum1 27 (\x105_0 -> (((F.exp (x65[x104_0][x104_1] F.+ (F.neg x70[x104_0]))) F.* x87[x104_0][x105_0][x104_1]) F.+ ((x95[x104_0][x105_0] F.* (one F.+ (F.neg (indicatorp (F.neg (x65[x104_0][x104_1] F.+ (F.neg x98[x104_0]))))))) F.* x100[x104_0]))))))
let x106 = (imap2 16 16 (\x107_0 x107_1 -> (isum1 27 (\x108_0 -> (x103[x107_0][x108_0] F.* wvoc[x108_0][x107_1])))))
let x109 = (imap2 16 16 (\x110_0 x110_1 -> x106[x110_0][x110_1]))
let x111 = (imap2 16 64 (\x112_0 x112_1 -> (isum1 16 (\x113_0 -> (x109[x112_0][x113_0] F.* wdown[x113_0][x112_1])))))
let x114 = (imap2 16 64 (\x115_0 x115_1 -> ((indicatorp x55[x115_0][x115_1]) F.* x111[x115_0][x115_1])))
let x116 = (imap2 16 16 (\x117_0 x117_1 -> (isum1 64 (\x118_0 -> (x114[x117_0][x118_0] F.* wup[x118_0][x117_1])))))
let x119 = (imap1 16 (\x120_0 -> ((isum1 16 (\x121_0 -> (x48[x120_0][x121_0] F.* x48[x120_0][x121_0]))) F./ fromi64 16)))
let x122 = (imap1 16 (\x123_0 -> (F.sqrt (x119[x123_0] F.+ (one F./ fromi64 100000)))))
let x124 = (imap1 16 (\x125_0 -> (isum1 16 (\x126_0 -> (F.neg ((x116[x125_0][x126_0] F.* x48[x125_0][x126_0]) F.* (one F./ (x122[x125_0] F.* x122[x125_0]))))))))
let x127 = (imap1 16 (\x128_0 -> (x124[x128_0] F.* (one F./ ((one F.+ one) F.* (F.sqrt (x119[x128_0] F.+ (one F./ fromi64 100000))))))))
let x129 = (imap2 16 16 (\x130_0 x130_1 -> (x109[x130_0][x130_1] F.+ ((x116[x130_0][x130_1] F.* (one F./ x122[x130_0])) F.+ (((x127[x130_0] F./ fromi64 16) F.* x48[x130_0][x130_1]) F.+ ((x127[x130_0] F./ fromi64 16) F.* x48[x130_0][x130_1]))))))
let x131 = (imap2 16 16 (\x132_0 x132_1 -> x129[x132_0][x132_1]))
let x133 = (imap2 16 16 (\x134_0 x134_1 -> (isum1 16 (\x135_0 -> (x131[x134_0][x135_0] F.* wout[x135_0][x134_1])))))
let x136 = (imap3 4 16 4 (\x137_0 x137_1 x137_2 -> x133[x137_1][((x137_0 * 4) + x137_2)]))
let x138 = (imap3 4 16 16 (\x139_0 x139_1 x139_2 -> (isum1 4 (\x140_0 -> (x21[x139_0][x139_1][x140_0] F.* x23[x139_0][x139_2][x140_0])))))
let x141 = (imap3 4 16 16 (\x142_0 x142_1 x142_2 -> ((x138[x142_0][x142_1][x142_2] F./ fromi64 2) F.+ mask[x142_1][x142_2])))
let x143 = (imap3 4 16 16 (\x144_0 x144_1 x144_2 -> (let x145 = (imaximum1 16 (\x148_0 -> x141[x144_0][x144_1][x148_0]))
in (let x146 = (imap1 16 (\x149_0 -> (F.exp (x141[x144_0][x144_1][x149_0] F.+ (F.neg x145)))))
in (let x147 = (isum1 16 (\x150_0 -> x146[x150_0]))
in (x146[x144_2] F.* (one F./ x147)))))))
let x151 = (imap3 4 16 16 (\x152_0 x152_1 x152_2 -> (isum1 4 (\x153_0 -> (x136[x152_0][x152_1][x153_0] F.* x25[x152_0][x152_2][x153_0])))))
let x154 = (imap2 4 16 (\x155_0 x155_1 -> (imaximum1 16 (\x156_0 -> x141[x155_0][x155_1][x156_0]))))
let x157 = (imap3 4 16 16 (\x158_0 x158_1 x158_2 -> (F.exp (x141[x158_0][x158_1][x158_2] F.+ (F.neg x154[x158_0][x158_1])))))
let x159 = (imap2 4 16 (\x160_0 x160_1 -> (isum1 16 (\x161_0 -> x157[x160_0][x160_1][x161_0]))))
let x162 = (imap2 4 16 (\x163_0 x163_1 -> (isum1 16 (\x164_0 -> (F.neg ((x151[x163_0][x163_1][x164_0] F.* x157[x163_0][x163_1][x164_0]) F.* (one F./ (x159[x163_0][x163_1] F.* x159[x163_0][x163_1]))))))))
let x165 = (imap3 4 16 16 (\x166_0 x166_1 x166_2 -> ((x151[x166_0][x166_1][x166_2] F.* (one F./ x159[x166_0][x166_1])) F.+ x162[x166_0][x166_1])))
let x167 = (imap2 4 16 (\x168_0 x168_1 -> (isum1 16 (\x169_0 -> (F.neg ((F.exp (x141[x168_0][x168_1][x169_0] F.+ (F.neg x154[x168_0][x168_1]))) F.* x165[x168_0][x168_1][x169_0]))))))
let x170 = (imap2 4 16 (\x171_0 x171_1 -> x154[x171_0][x171_1]))
let x172 = (imap2 4 16 (\x173_0 x173_1 -> (one F./ (isum1 16 (\x174_0 -> (one F.+ (F.neg (indicatorp (F.neg (x141[x173_0][x173_1][x174_0] F.+ (F.neg x170[x173_0][x173_1])))))))))))
let x175 = (imap3 4 16 16 (\x176_0 x176_1 x176_2 -> (((F.exp (x141[x176_0][x176_1][x176_2] F.+ (F.neg x154[x176_0][x176_1]))) F.* x165[x176_0][x176_1][x176_2]) F.+ ((x167[x176_0][x176_1] F.* (one F.+ (F.neg (indicatorp (F.neg (x141[x176_0][x176_1][x176_2] F.+ (F.neg x170[x176_0][x176_1]))))))) F.* x172[x176_0][x176_1]))))
let x177 = (imap3 4 16 16 (\x178_0 x178_1 x178_2 -> (x175[x178_0][x178_1][x178_2] F./ fromi64 2)))
let x179 = (imap3 4 16 4 (\x180_0 x180_1 x180_2 -> (isum1 16 (\x181_0 -> (x136[x180_0][x181_0][x180_2] F.* x143[x180_0][x181_0][x180_1])))))
let x182 = (imap3 4 16 4 (\x183_0 x183_1 x183_2 -> (isum1 16 (\x184_0 -> (x177[x183_0][x184_0][x183_1] F.* x21[x183_0][x184_0][x183_2])))))
let x185 = (imap3 4 16 4 (\x186_0 x186_1 x186_2 -> (isum1 16 (\x187_0 -> (x177[x186_0][x186_1][x187_0] F.* x23[x186_0][x187_0][x186_2])))))
let x188 = (imap2 16 16 (\x189_0 x189_1 -> x179[(x189_1 / 4)][x189_0][(x189_1 % 4)]))
let x190 = (imap2 16 16 (\x191_0 x191_1 -> x182[(x191_1 / 4)][x191_0][(x191_1 % 4)]))
let x192 = (imap2 16 16 (\x193_0 x193_1 -> x185[(x193_1 / 4)][x193_0][(x193_1 % 4)]))
let x194 = (imap2 16 16 (\x195_0 x195_1 -> (((isum1 16 (\x196_0 -> (x188[x195_0][x196_0] F.* wval[x196_0][x195_1]))) F.+ (isum1 16 (\x197_0 -> (x190[x195_0][x197_0] F.* wkey[x197_0][x195_1])))) F.+ (isum1 16 (\x198_0 -> (x192[x195_0][x198_0] F.* wqry[x198_0][x195_1]))))))
let x199 = (imap1 16 (\x200_0 -> ((isum1 16 (\x201_0 -> (x2[x200_0][x201_0] F.* x2[x200_0][x201_0]))) F./ fromi64 16)))
let x202 = (imap1 16 (\x203_0 -> (F.sqrt (x199[x203_0] F.+ (one F./ fromi64 100000)))))
let x204 = (imap1 16 (\x205_0 -> (isum1 16 (\x206_0 -> (F.neg ((x194[x205_0][x206_0] F.* x2[x205_0][x206_0]) F.* (one F./ (x202[x205_0] F.* x202[x205_0]))))))))
let x207 = (imap1 16 (\x208_0 -> (x204[x208_0] F.* (one F./ ((one F.+ one) F.* (F.sqrt (x199[x208_0] F.+ (one F./ fromi64 100000))))))))
let x209 = (imap2 16 16 (\x210_0 x210_1 -> (x131[x210_0][x210_1] F.+ ((x194[x210_0][x210_1] F.* (one F./ x202[x210_0])) F.+ (((x207[x210_0] F./ fromi64 16) F.* x2[x210_0][x210_1]) F.+ ((x207[x210_0] F./ fromi64 16) F.* x2[x210_0][x210_1]))))))
let x211 = (imap1 16 (\x212_0 -> ((isum1 16 (\x213_0 -> (x0[x212_0][x213_0] F.* x0[x212_0][x213_0]))) F./ fromi64 16)))
let x214 = (imap1 16 (\x215_0 -> (F.sqrt (x211[x215_0] F.+ (one F./ fromi64 100000)))))
let x216 = (imap1 16 (\x217_0 -> (isum1 16 (\x218_0 -> (F.neg ((x209[x217_0][x218_0] F.* x0[x217_0][x218_0]) F.* (one F./ (x214[x217_0] F.* x214[x217_0]))))))))
let x219 = (imap1 16 (\x220_0 -> (x216[x220_0] F.* (one F./ ((one F.+ one) F.* (F.sqrt (x211[x220_0] F.+ (one F./ fromi64 100000))))))))
let x221 = (imap2 16 16 (\x222_0 x222_1 -> ((x209[x222_0][x222_1] F.* (one F./ x214[x222_0])) F.+ (((x219[x222_0] F./ fromi64 16) F.* x0[x222_0][x222_1]) F.+ ((x219[x222_0] F./ fromi64 16) F.* x0[x222_0][x222_1])))))

let dmask = (imap2 16 16 (\x224_0 x224_1 -> (isum1 4 (\x223_0 -> x175[x223_0][x224_0][x224_1]))))
let dwpe = (imap2 16 16 (\x225_0 x225_1 -> x221[x225_0][x225_1]))
let dwqry = (imap2 16 16 (\x226_0 x226_1 -> (isum1 16 (\x227_0 -> (x192[x227_0][x226_0] F.* x7[x227_0][x226_1])))))
let dwkey = (imap2 16 16 (\x228_0 x228_1 -> (isum1 16 (\x229_0 -> (x190[x229_0][x228_0] F.* x7[x229_0][x228_1])))))
let dwval = (imap2 16 16 (\x230_0 x230_1 -> (isum1 16 (\x231_0 -> (x188[x231_0][x230_0] F.* x7[x231_0][x230_1])))))
let dwout = (imap2 16 16 (\x232_0 x232_1 -> (isum1 16 (\x233_0 -> (x131[x233_0][x232_0] F.* x43[x233_0][x232_1])))))
let dwup = (imap2 64 16 (\x234_0 x234_1 -> (isum1 16 (\x235_0 -> (x114[x235_0][x234_0] F.* x50[x235_0][x234_1])))))
let dwdown = (imap2 16 64 (\x236_0 x236_1 -> (isum1 16 (\x237_0 -> (x109[x237_0][x236_0] F.* x58[x237_0][x236_1])))))
let dwvoc = (imap2 27 16 (\x238_0 x238_1 -> (isum1 16 (\x239_0 -> (x103[x239_0][x238_0] F.* x63[x239_0][x238_1])))))
let dwseq = (imap2 16 16 (\x240_0 x240_1 -> x221[x240_0][x240_1]))
let dtarget = (imap2 16 27 (\x241_0 x241_1 -> (let x242 = (imaximum1 27 (\x245_0 -> x65[x241_0][x245_0]))
in (let x243 = (imap1 27 (\x246_0 -> (F.exp (x65[x241_0][x246_0] F.+ (F.neg x242)))))
in (let x244 = (isum1 27 (\x247_0 -> x243[x247_0]))
in ((F.neg x68[x241_0]) F.* (F.log (x243[x241_1] F.* (one F./ x244)))))))))
