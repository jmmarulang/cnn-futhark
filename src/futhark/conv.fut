...
module nn (F: real) = {
  ...
  -> ( [6][5][5]real
    ...
    \(inp: [28][28]real) (k1: [6][5][5]real) (b1: [6]real) (k2: [12][6][5][5]real) (b2: [12]real) (fc': [10][12][4][4]real) (b: [10]real) (target': [10]real) ->
      ...
      let _ = (imap2 28 28 (\x46_0 x46_1 -> (isum1 6 (\x44_0 -> (isum2 5 5 (\x45_0 x45_1 -> if (x46_0 >= x45_0 && x46_1 >= x45_1 && (x46_0 - x45_0) < 24 && (x46_1 - x45_1) < 24) then (x42[x44_0][(x46_0 - x45_0)][(x46_1 - x45_1)] F.* k1[x44_0][x45_0][x45_1]) else zero))))))
