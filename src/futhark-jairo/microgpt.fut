...
module nn (F: real) = {
  ...
  def train_gen : (atmask: [SL][SL]real)
    -> (wte: [VS][ED]real)
    -> (wpe: [SL][ED]real)
    -> (wqry: [ED][ED]real)
    -> (wkey: [ED][ED]real)
    ...
    -> real =
    --#[unsafe]
    \(atmask : [SL][SL]real) (wte':[VS][ED]real) (wpe':[SL][ED]real) (wqry':[ED][ED]real) (wkey':[ED][ED]real) (wval':[ED][ED]real) (wout':[ED][ED]real) 
     (wout: [ED][ED]real) (wup': [FDxED][ED]real) (wdown': [ED][FDxED]real) (wvoc': [VS][ED]real) (docid: [SL][VS]real) (target: [SL][VS]real)
